...
* This Splunk connector 3.0.0 is compatible with Mule 4.
...
== See Also
* https://github.com/Apisero-Connectors/mule4-splunk-connector-doc/blob/master/doc/release-notes.adoc[​Splunk Connector Release Notes]
